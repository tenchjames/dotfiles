...
export GITUSER="tenchjames"
export GHREPOS="$REPOS/github.com/$GITUSER"
export DOTFILES="$GHREPOS/dotfiles"
export PLAYGROUND="$GHREPOS/playground"
...
PATH="${PATH:+${PATH}:}"$SCRIPTS":/opt/homebrew/bin"
...
# colorized prompt
# PROMPT_COMMAND='__git_ps1 "\[\e[33m\]\u\[\e[0m\]@\[\e[34m\]\[\e[0m\]:\[\e[35m\]\W\[\e[0m\]" " \n$ "'
...
# alias ex='cd $REPOS/github.com/tenchjames/go/Exercism/'
...
alias gs='git status'
alias lg='lazygit'
alias glg='git log --oneline --graph --decorate --parents'
...
# export PATH="/Users/tenchjames/.rd/bin:$PATH"
...
# Ensure Neovim directories have proper permissions on startup
if [ -d "$HOME/.local/share/nvim" ]; then
  chmod -R u+w "$HOME/.local/share/nvim/lazy/" 2>/dev/null
fi
